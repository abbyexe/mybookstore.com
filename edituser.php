...
$sql = "SELECT users.UserName, users.Password, customer.CustomerName, customer.CustomerUPI, customer.CustomerEmail, customer.CustomerPhone, customer.CustomerGender, customer.CustomerAddress
	FROM users, customer
										...
										if(!preg_match("/^[0-9 -]*$/", $contact)){
											...
											if (empty($_POST["gender"])){
												...
												if (empty($_POST["address"])){
													...
													CustomerUPI = '".$ic."', CustomerEmail = '".$email."', CustomerAddress = '".$address."', 
...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	UPI ID:<br><input type="text" name="ic" placeholder="<?php echo $oIC; ?>">
